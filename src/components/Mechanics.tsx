...
import { BarChart3, Eye, Shield, Zap, Database, TrendingUp } from 'lucide-react';
...
const Backoffice = () => {
  ...
  return (
    <section id="backoffice" className="py-20 bg-brand-dark-gradient">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div ref={titleRef} className={`text-center mb-8 transition-all duration-500 ${
          ...
          <h2 className="text-4xl md:text-6xl font-heading font-black uppercase tracking-wider text-white mb-6">
            Built for{' '}
