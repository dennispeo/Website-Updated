...
const ZeusGamePage = () => {
  ...
  const gameStats = {
    ...
    minBet: '€0.20',
    maxBet: '€100.00',
    releaseDate: '25-03-2025',
    earlyAccess: '17-03-2025'
  };
              ...
              <div className="space-y-8">
                <div>
                  <h1 className="text-5xl md:text-7xl font-heading font-black uppercase text-white mb-4">
                    Zeus: <span className="text-brand-orange">Clockwork</span> Tyrant
                  </h1>
                  <p className="text-xl text-gray-300 leading-relaxed font-body">
                    Enter an oppressive myth-tech world where ancient power meets mechanical precision. 
                    Experience the revolutionary wavE™ mechanic that transforms every spin into digital chaos.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="bg-black/40 p-4 rounded-lg border border-gray-800">
                    <div className="text-2xl font-bold text-brand-orange font-heading">{gameStats.rtp}</div>
                    <div className="text-sm text-gray-400 uppercase tracking-wider font-body">RTP</div>
                  </div>
                  <div className="bg-black/40 p-4 rounded-lg border border-gray-800">
                    <div className="text-2xl font-bold text-brand-orange font-heading">{gameStats.maxWin}</div>
                    <div className="text-sm text-gray-400 uppercase tracking-wider font-body">Max Win</div>
                  </div>
                  <div className="bg-black/40 p-4 rounded-lg border border-gray-800">
                    <div className="text-2xl font-bold text-brand-orange font-heading">{gameStats.volatility}</div>
                    <div className="text-sm text-gray-400 uppercase tracking-wider font-body">Volatility</div>
                  </div>
                  <div className="bg-black/40 p-4 rounded-lg border border-gray-800">
                    <div className="text-2xl font-bold text-brand-orange font-heading">{gameStats.hitFrequency}</div>
              ...
              <div className="space-y-16">
                ...
                <div className="max-w-4xl mx-auto text-center">
                  ...
                  <p className="text-lg text-gray-300 leading-relaxed font-body">
                    Zeus: Clockwork Tyrant represents the pinnacle of our Digital Chaos philosophy. 
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                  <div className="bg-black/30 p-8 rounded-xl border border-gray-800">
                    ...
                    <div className="text-3xl font-bold text-white mb-2 font-heading">{gameStats.earlyAccess}</div>
                  ...
                  <div className="bg-black/30 p-8 rounded-xl border border-gray-800">
                    ...
                    <div className="text-3xl font-bold text-white mb-2 font-heading">{gameStats.releaseDate}</div>
            ...
            {activeTab === 'statistics' && (
              <div ref={statsRef} className={`transition-all duration-800 ${
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  {[
                    { label: 'Return to Player', value: gameStats.rtp, description: 'Theoretical return percentage' },
                    { label: 'Volatility Level', value: gameStats.volatility, description: 'Risk and reward balance' },
                    { label: 'Hit Frequency', value: gameStats.hitFrequency, description: 'Winning spin probability' },
                    { label: 'Maximum Win', value: gameStats.maxWin, description: 'Highest possible payout' },
                    { label: 'Free Spins Trigger', value: gameStats.freeSpins, description: 'Bonus round frequency' },
                    { label: 'Reel Configuration', value: gameStats.reelsRows, description: 'Game grid layout' },
                    { label: 'Minimum Bet', value: gameStats.minBet, description: 'Lowest stake amount' },
                    { label: 'Maximum Bet', value: gameStats.maxBet, description: 'Highest stake amount' },
